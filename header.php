...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<!---<div class="site-branding">
			...
			$youhadmeat_theme_description = get_bloginfo( 'description', 'display' );
			if ( $youhadmeat_theme_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $youhadmeat_theme_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>

			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'youhadmeat_theme' ); ?></button>
			<?php
			wp_nav_menu( array(
