...
if ( defined( 'JETPACK__VERSION' ) ) {
	...
	function show_custom_template_options() {
		...
		<input type="checkbox" name="featured-is-fixed" id="featured-is-fixed" value="true" <?php if ( isset ( $meta['featured-is-fixed'] ) && $meta['featured-is-fixed'] == true  ) echo 'checked="true"'; ?> />
		<br>
