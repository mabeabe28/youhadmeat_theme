		  	...
		  	foreach($recent_categories as $category) {
					...
					if($ParentCategory->count > 0){
						...
						if(has_post_thumbnail($recent_post[0]["ID"])){
							...
							echo '  <div class="slide__container js-slider" style="background-image:linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url('.get_the_post_thumbnail_url($recent_post[0]["ID"], 'large').');"">
