		...
		echo '<div class="frame">
			...
			foreach($recent_posts_all as $post){
				...
				/*echo'	<li class="card post--'.$post["ID"].' category--'.$curParentCategory->slug.'">
					...
					echo'
					<li class="frame post--'.$post["ID"].' category--'.$curParentCategory->slug.'">
						<a href="'.$curPostUrl.'">
					...
					echo '
					<div class="frame__container" style="background-image:linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.2)), url('.get_the_post_thumbnail_url($post["ID"], 'large').');">
					</div>
					';
